...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy EDITED
    nSubsidy >>= (nHeight / 105000); // EDIT

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60 * 2; //EDIT 7 DAYS
static const int64 nTargetSpacing = 1 * 60; //  Edit nTarget
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "I think this should work";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
